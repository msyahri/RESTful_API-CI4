			...
			<div class="wrap-login100">
                ...
                <div class="alert alert-danger" align="center">
					...
					<div class="wrap-input100 validate-input" data-validate = "Masukkan Username!">
						<input type="text" name="member_username" value="<?php echo session()->getFlashdata('member_username') ?>" class="input100" id="inputUsername" placeholder="Masukkan Username....">
